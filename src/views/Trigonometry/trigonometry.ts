...
export default async function Trigonometry() {
  Layout();
  const layoutContent = document.getElementById("content") as HTMLDivElement;

  const trigonometryHTML = `
    <canvas id="canvas" width="500" height="500" style="background-color: white;" tabindex="1" style="margin: 50px;"></canvas>
    `;
  layoutContent.innerHTML = trigonometryHTML;
